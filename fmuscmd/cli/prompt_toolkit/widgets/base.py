    ...
    def __init__(
        ...
        self.control = BufferControl(
            ...
            input_processors=[
                ...
                # TabsProcessor,  # ini selalu ngehang
            ]
            + input_processors,
...
class Button:
    ...
    def __init__(
        ...
        self.window = Window(
            ...
            height=1,
            width=width,
            # apa harus selalu callable?
            style=style if style else get_style,
...
class ProgressBar:
    def __init__(self, percentage=10) -> None:
        self._percentage = percentage
        self.label = Label(f"{percentage}%")
        self.container = FloatContainer(
