...
from app.printutils import (print_copy)
...
def gen_mkfile(RootNode, project_dir='input'):
	...
	# template_app_content = gen_template_app_content(tables)
	# replace_me = replace_me.replace('__TEMPLATE_APP_CONTENT', template_app_content)

	# import_lines = gen_template_app_imports(tables)
	# replace_me = replace_me.replace('__TEMPLATE_APP_IMPORTS', import_lines)

	# route_lines = gen_template_app_routes(tables)
	# replace_me = replace_me.replace('__TEMPLATE_APP_ROUTES', route_lines)

	# print_copy(replace_me)
