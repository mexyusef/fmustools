...
colors = None
DO_RESIZE = False
# import_internal_help = 'from upython._internal import _help as help'
import_internal_help = 'from vendor.upython._internal import _help as help'
...
class CLIRepl(repl.Repl):
    ...
    def repl(self):
        ...
        self.push(f'{import_internal_help}\n', False)
...
########### kumpulkan fungsi2 tanpa masalah
