...
class Generator:
  ...
  def fmus_cmd(self, tree):
    ...
    for item in anak(tree):
      if data(item) == 'fmus_execute':
        ...
        # from schnell.app.dirutils import here
  ...
  def classcontent(self, tree, structname=None):
    ...
    if ctor_method_field.data == 'constructor_content':
      ...
      field_config, field_name, field_type, field_value, is_static = self.field_content(ctor_method_field)
      # return item
      return [field_config, field_name, field_type, field_value, is_static], 'field'
    ...
    for classcontent in anak(tree):
      ...
      if jenis is not None and jenis == 'field':
        ...
        if hasil[4]: # is_static
          ...
          initialize_method_member.update({
            hasil[1]: hasil
          })
      elif hasil:
  ...
  def searchable(self, tree, filepath='imports_py.txt'):
    """
    searchable
      searchable_kw
  ...
  def import_item(self, tree):
    ...
    for item in anak(tree):
      ...
      #     merged_imports.append(item)
        ...
        search_mode = True
        filepath = joiner(here(__file__), '..', 'import_py.txt')
