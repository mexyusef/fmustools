...
class Generator:
  ...
  def method_content(self, tree, structname=None):
    ...
    for item in anak(tree):
      if data(item) == 'function_name':
        ...
        function_name = self.nama_identifier_with_typeparams(nama_identifier_with_typeparams)
        # kembali += f'{nama}'
      elif data(item) == 'tipe_identifier':
  ...
  def rust_initialize_field(self, structname, fieldname, nilai):
    ...
    hasil = rust_struct_template.replace('__structname', structname) \
  ...
  def class_item(self, tree, returning=True):
    """
    class_item
      class_name
        nama_identifier_with_typeparams
    ...
    for item in anak(tree):
      if data(item) == 'class_name':
        ...
        classcontent, field_name_impl = self.class_content(item, structname=classname)
