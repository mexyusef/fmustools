...
from schnell.app.transpiler.zgenerate.refactor.handlers import constructor_content
from schnell.app.transpiler.zgenerate.refactor.handlers import method_content
from schnell.app.transpiler.zgenerate.refactor.handlers import field_content
...
def classcontent(tree, structname=None, language='py'):
  ...
  if ctor_method_field.data == 'constructor_content':
    item = constructor_content.constructor_content(ctor_method_field, structname=structname, language=language)
