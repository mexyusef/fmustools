...
from schnell.app.transpiler.zgenerate.refactor.handlers import function_name
...
def function_item(tree, language='py'):
  ...
  for item in anak(tree):
    ...
    if data(item) == 'keyword_function':
      ...
      print('mau panggil function name, lihat tipe:', type(function_name), type(item), type(language))
