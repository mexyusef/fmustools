...
from schnell.app.transpiler.zgenerate.refactor.handlers import dataops_statement
...
def dataops_statement_with_identifier(tree, language='py'):
  ...
  for item in anak(tree):
    if data(item) == 'nama_identifier':
      ...
      rhs = dataops_statement.dataops_statement(item, identifier, language=language)
