...
from schnell.app.transpiler.zgenerate.refactor.handlers import named_values
  ...
  for arg in anak(tree):
    ...
    for tipearg in anak(arg):
      if data(tipearg) == 'named_values':
        ...
        hasil = anonymous_function.anonymous_function(tipearg, language=language)
        hasil = stringify_anonymous_function_result.stringify_anonymous_function_result(hasil, language=language)
