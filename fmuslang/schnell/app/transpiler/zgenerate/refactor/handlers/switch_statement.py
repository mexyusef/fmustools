...
from schnell.app.transpiler.zgenerate.refactor.handlers import condition_switch
from schnell.app.transpiler.zgenerate.refactor.handlers import case_body
...
def switch_statement(tree, language='py'):
  ...
  for item in anak(tree):
    if data(item) == 'switch_keyword':
      ...
      _case_body = case_body.case_body(item, terbanding, first_case, language=language)
