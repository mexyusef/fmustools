...
from schnell.app.transpiler.zgenerate.refactor.handlers import nama_jenis_identifier
...
def paramlist(tree, language='py'):
  ...
  for param in anak(tree):
    ...
    if data(paramchild) == 'nama_identifier':
      ...
      paramname_dan_tipe = named_values.named_values(paramchild, language=language)
    elif data(paramchild) == 'nama_jenis_identifier':
      tipe_data = nama_jenis_identifier.nama_jenis_identifier(paramchild, language=language)
