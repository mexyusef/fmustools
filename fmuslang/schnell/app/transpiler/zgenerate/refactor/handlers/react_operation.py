...
from schnell.app.transpiler.zgenerate.refactor.handlers import tipe_identifier, expression_item
  ...
  for item in anak(tree):
    ...
    if jenis == 'tipe_identifier':
      ...
      if hasil == 'string':
        ...
        kembali = '0'
      elif hasil == 'number': # stlh /ts/ jadi number, dari peta_tipe_data dan tipe_identifier()
        kembali = '0'
      elif hasil == 'boolean':
        kembali = 'false'
      elif hasil == 'array':
