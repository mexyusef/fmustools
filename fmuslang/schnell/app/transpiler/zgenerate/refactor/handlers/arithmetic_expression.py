...
from schnell.app.transpiler.zgenerate.refactor.handlers import arithmetic_operator_to_string
...
def arithmetic_expression(tree, language='py'):
  ...
  oper = arithmetic_operator_to_string.arithmetic_operator_to_string(child2(tree), language=language)
