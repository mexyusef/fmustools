...
from schnell.app.transpiler.zgenerate.refactor.handlers import classcontent
...
def classcontentlist(tree, structname=None, language='py'):
  ...
  for _classcontent in anak(tree):
    hasil = classcontent.classcontent(_classcontent, structname=structname, language=language)
    if hasil:
