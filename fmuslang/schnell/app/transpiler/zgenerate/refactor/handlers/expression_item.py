...
from schnell.app.transpiler.zgenerate.refactor.handlers import ternary_expression
...
def expression_item(tree, language='py'):
  ...
  if data(provided_expression) == 'literal':    
    ...
    hasil = relational_expression.relational_expression(provided_expression, language=language)
    ...
    hasil = arithmetic_expression.arithmetic_expression(provided_expression, language=language)
  elif data(provided_expression) == 'casting_expression':
    hasil = casting_expression.casting_expression(provided_expression, language=language)
  elif data(provided_expression) == 'range_expression':
    hasil = range_expression.range_expression(provided_expression, language=language)
  elif data(provided_expression) == 'member_index_expression':
    hasil = member_index_expression.member_index_expression(provided_expression, language=language)
  elif data(provided_expression) == 'member_dot_expression':
    hasil = member_dot_expression.member_dot_expression(provided_expression, language=language)
  elif data(provided_expression) == 'ternary_expression':
    # print('panggil ternary_expression dari expression_item')
    hasil = ternary_expression.ternary_expression(provided_expression, language=language)
  elif data(provided_expression) == 'anonymous_function':
    hasil_in_dict = anonymous_function.anonymous_function(provided_expression, language=language)
