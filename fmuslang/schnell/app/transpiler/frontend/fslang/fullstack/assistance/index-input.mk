...
__TEMPLATE_APP_CONTENT
  mymigrations,d(/mk)
    migrations,d(/mk)
      sql_pg_dialect.sql,f(e=utama=/sql_pg_dialect.sql)
    docker-cmd.sh,f(e=utama=/docker-cmd.sh)
    flyway-cmd.sh,f(e=utama=/flyway-cmd.sh)
    jsondata.json,f(e=utama=/jsondata.json)
    jsondata-result.json,f(e=utama=/jsondata-result.json)
    csvdata.csv,f(e=utama=/csvdata.csv)
    grpc.service,f(e=utama=/grpc.service)
    typescript-related.js,f(e=utama=/typescript-related.js)
    springboot.gql,f(e=utama=/springboot.gql)
    nest-v1.js,f(e=utama=/nest-v1.js)
--#

--% gak perlu
.,d
  extras,d(/mk)
    cart,d(/mk,/load=ULIBPY_BASEDIR/app/transpiler/frontend/fslang/fullstack/assistance/extras/cart.mk=index/fmus)
    order,d(/mk,/load=ULIBPY_BASEDIR/app/transpiler/frontend/fslang/fullstack/assistance/extras/order.mk=index/fmus)
    product,d(/mk,/load=ULIBPY_BASEDIR/app/transpiler/frontend/fslang/fullstack/assistance/extras/product.mk=index/fmus)
    user,d(/mk,/load=ULIBPY_BASEDIR/app/transpiler/frontend/fslang/fullstack/assistance/extras/user.mk=index/fmus)
  store,d(/mk)
    user,d(/mk)
      userActions.js,f(t=)
