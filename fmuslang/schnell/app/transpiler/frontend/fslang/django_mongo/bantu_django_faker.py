...
def gen_jsondata(tablename, records, mkfile_input_content):
	"""
	...
	try:		
		...
		# --% /apps/News/__TABLENAME_LOWER__.json
		header = f'/apps/{tablename}/{tablename.lower()}.json'
		result = append_entry_tostring(mkfile_input_content, header, hasil)
		return result
