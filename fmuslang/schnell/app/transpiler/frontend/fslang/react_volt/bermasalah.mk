...
--% index/fmus
.,d
    _checkbox-radio-switch.scss,f(F=/mnt/c/dahsyat/javascript/react-light/src/assets/scss/lbd/_checkbox-radio-switch.scss)
    _partial-nucleo-icons.scss,f(F=/mnt/c/dahsyat/javascript/react-light/src/assets/scss/lbd/_partial-nucleo-icons.scss)
--#


--% /react-light/src/assets/scss/lbd/_checkbox-radio-switch.scss
.from-check,
.form-check-radio {
    margin-bottom: 12px;
    position: relative;
...
--% /react-light/src/assets/scss/lbd/_partial-nucleo-icons.scss
/*--------------------------------
