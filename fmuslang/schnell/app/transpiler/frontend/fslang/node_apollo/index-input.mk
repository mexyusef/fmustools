...
__TEMPLATE_APP_INIT
  ...
  webpack-apollo-template.js,f(e=utama=/webpack-apollo-template)
  package.json,f(e=utama=/package.json)
  yarn.lock,f(e=ULIBPY_BASEDIR/app/transpiler/frontend/fslang/node_apollo/resources.mk=/yarn.lock)
  src,d(/mk)
...
--% /webpack-apollo-template
// "pg": "rm -rf dist && webpack --mode development --config webpack-node-pg",
const path = require('path');
...
webpack_postgres = {
  ...
  output: {
    path: path.resolve(process.cwd(), 'apollo-dist'),
    publicPath: '/',
    filename: '[name].js'
  },
  ...
  resolve: {
    ...
    alias: {
      ...
      F: path.resolve(process.cwd(), sourcedir, 'core/config'),
      N: path.resolve(process.cwd(), sourcedir, 'core/connection'),
      DB: path.resolve(process.cwd(), sourcedir, 'core/connection/db'),
      G: path.resolve(process.cwd(), sourcedir, 'core/connection/graphql'),
      E: path.resolve(process.cwd(), sourcedir, 'core/errors'),
      L: path.resolve(process.cwd(), sourcedir, 'core/logger'),
...
--% /package.json
{
  ...
  "license": "MIT",
  "scripts": {
    "start": "rm -rf apollo-dist && webpack serve --mode development --config webpack-apollo-template"
  },
  "dependencies": {
