...
cnxjs,d(/mk)
  %utama=__FILE__
  .eslintrc.json,f(e=utama=C:/work/tmp/tmp/cnxjs/.eslintrc.json)
  .gitignore,f(e=utama=C:/work/tmp/tmp/cnxjs/.gitignore)
  next.config.js,f(e=utama=C:/work/tmp/tmp/cnxjs/next.config.js)
  package.json,f(e=ULIBPY_BASEDIR/app/transpiler/frontend/fslang/misc/cnxjs/package2.fmus=C:/work/tmp/tmp/cnxjs/package.json)
  README.md,f(e=utama=C:/work/tmp/tmp/cnxjs/README.md)
  pages,d(/mk)
    index.js,f(e=utama=C:/work/tmp/tmp/cnxjs/pages/index.js)
    _app.js,f(e=utama=C:/work/tmp/tmp/cnxjs/pages/_app.js)
    api,d(/mk)
      hello.js,f(e=utama=C:/work/tmp/tmp/cnxjs/pages/api/hello.js)
  public,d(/mk)
    favicon.ico,f(b64=utama=C:/work/tmp/tmp/cnxjs/public/favicon.ico)
    vercel.svg,f(e=utama=C:/work/tmp/tmp/cnxjs/public/vercel.svg)
  styles,d(/mk)
    globals.css,f(e=utama=C:/work/tmp/tmp/cnxjs/styles/globals.css)
    Home.module.css,f(e=utama=C:/work/tmp/tmp/cnxjs/styles/Home.module.css)
--#

--% C:/work/tmp/tmp/cnxjs/.eslintrc.json
{
...
--% C:/work/tmp/tmp/cnxjs/.gitignore
...
--% C:/work/tmp/tmp/cnxjs/next.config.js
...
--% C:/work/tmp/tmp/cnxjs/README.md
...
--% C:/work/tmp/tmp/cnxjs/pages/index.js
...
--% C:/work/tmp/tmp/cnxjs/pages/_app.js
...
--% C:/work/tmp/tmp/cnxjs/pages/api/hello.js
...
--% C:/work/tmp/tmp/cnxjs/public/favicon.ico
...
--% C:/work/tmp/tmp/cnxjs/public/vercel.svg
...
--% C:/work/tmp/tmp/cnxjs/styles/globals.css
html,
body {
  padding: 0;
  margin: 0;
...
--% C:/work/tmp/tmp/cnxjs/styles/Home.module.css
.container {
  padding: 0 2rem;
}
