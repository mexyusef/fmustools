...
export const __TABLENAME_LOWER__ListReducer = (state = { __TABLENAME_LOWER__s: []}, action) => {
  switch (action.type) {
    ...
    case __TABLENAME_UPPER___LIST_SUCCESS:
      return { loading: false, __TABLENAME_LOWER__s: action.payload, }
      // return { loading: false, __TABLENAME_LOWER__s: action.payload.__TABLENAME_LOWER__s, page: action.payload.page, pages: action.payload.pages }
