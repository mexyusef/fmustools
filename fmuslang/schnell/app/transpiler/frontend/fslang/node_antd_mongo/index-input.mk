...
__TEMPLATE_APP_INIT
  ...
  docker-compose.yml,f(e=utama=/np/docker-compose.yml)
  webpack-antd.js,f(e=utama=/np/webpack-antd.js)
  webpack-node-pg.js,f(e=utama=/np/webpack-node-pg.js)
  $*ln -s /mnt/c/node_modules/node-antd-mg/node_modules .
  node-mongodb,d(/mk)
    .gitignore,f(e=utama=/np/node-mongodb/.gitignore)
    .eslintrc.js,f(e=utama=/np/node-mongodb/.eslintrc.js)
    README.md,f(e=utama=/np/node-mongodb/README.md)
    .babelrc,f(e=utama=/np/node-mongodb/.babelrc)
    src,d(/mk)
      config.js,f(e=utama=/np/node-mongodb/src/config.js)
      public,d(/mk)
      core,d(/mk)
        crud-mongoose.js,f(e=utama=/np/node-mongodb/src/core/crud-mongoose.js)
        extender.js,f(e=utama=/np/node-mongodb/src/core/extender.js)
        crud.js,f(e=utama=/np/node-mongodb/src/core/crud.js)
        app.js,f(e=utama=/np/node-mongodb/src/core/app.js)
        routes,d(/mk)
          index.js,f(e=utama=/np/node-mongodb/src/core/routes/index.js)
          extension,d(/mk)
            index.js,f(e=utama=/np/node-mongodb/src/core/routes/extension/index.js)
          dummy,d(/mk)
            index.js,f(e=utama=/np/node-mongodb/src/core/routes/dummy/index.js)
          api,d(/mk)
            users.js,f(e=utama=/np/node-mongodb/src/core/routes/api/users.js)
            index.js,f(e=utama=/np/node-mongodb/src/core/routes/api/index.js)
            auth.js,f(e=utama=/np/node-mongodb/src/core/routes/api/auth.js)
          generic,d(/mk)
            index.js,f(e=utama=/np/node-mongodb/src/core/routes/generic/index.js)
        middlewares,d(/mk)
          cors.js,f(e=utama=/np/node-mongodb/src/core/middlewares/cors.js)
          index.js,f(e=utama=/np/node-mongodb/src/core/middlewares/index.js)
          session.js,f(e=utama=/np/node-mongodb/src/core/middlewares/session.js)
          body.js,f(e=utama=/np/node-mongodb/src/core/middlewares/body.js)
          uploader.js,f(e=utama=/np/node-mongodb/src/core/middlewares/uploader.js)
          morgan.js,f(e=utama=/np/node-mongodb/src/core/middlewares/morgan.js)
          auth.js,f(e=utama=/np/node-mongodb/src/core/middlewares/auth.js)
        utils,d(/mk)
        db,d(/mk)
          mongo.js,f(e=utama=/np/node-mongodb/src/core/db/mongo.js)
          postgres.js,f(e=utama=/np/node-mongodb/src/core/db/postgres.js)
          index.js,f(e=utama=/np/node-mongodb/src/core/db/index.js)
          firebasedb.js,f(e=utama=/np/node-mongodb/src/core/db/firebasedb.js)
          firebasekey.json,f(e=utama=/np/node-mongodb/src/core/db/firebasekey.json)
      apps,d(/mk)
        index.js,f(e=utama=/np/node-mongodb/src/apps/index.js/hasil_creation)
        user,d(/mk)
          # user_extender.js,f(e=utama=/np/node-mongodb/src/apps/user/extender.js)
          models,d(/mk)
            mongo.js,f(e=utama=/np/node-mongodb/src/apps/user/models/mongo.js)
            postgres.js,f(e=utama=/np/node-mongodb/src/apps/user/models/postgres.js)
            index.js,f(e=utama=/np/node-mongodb/src/apps/user/models/index.js)
          auth,d(/mk)
            index.js,f(e=utama=/np/node-mongodb/src/apps/user/auth/index.js)
            token.js,f(e=utama=/np/node-mongodb/src/apps/user/auth/token.js)
            token_mongo.js,f(e=utama=/np/node-mongodb/src/apps/user/auth/token_mongo.js)
            provider.js,f(e=utama=/np/node-mongodb/src/apps/user/auth/provider.js)
            kripto.js,f(e=utama=/np/node-mongodb/src/apps/user/auth/kripto.js)
            jwt.js,f(e=utama=/np/node-mongodb/src/apps/user/auth/jwt.js)
__TEMPLATE_SERVER_APP_CONTENT
        user,d(/mk)
          extender.js,f(e=utama=/np/node-mongodb/src/apps/user/extender.js)
      server,d(/mk)
        server-dev.js,f(e=utama=/np/node-mongodb/src/server/server-dev.js)
        server-prod.js,f(e=utama=/np/node-mongodb/src/server/server-prod.js)
    __mocks__,d(/mk)
      styleMock.js,f(e=utama=/np/node-mongodb/__mocks__/styleMock.js)
      fileMock.js,f(e=utama=/np/node-mongodb/__mocks__/fileMock.js)
  react-antd,d(/mk)
...
http://localhost:7280/product

*~localhost:7280/product p json {}

http://localhost:7280/category

*~localhost:7280/category p json {name=miscellaneous,slug=misc}
*~localhost:7280/category p json {name=electronics,slug=electronics}

*~localhost:7280/product p json {title=kipas angin apa,slug=kipas-angin-apa,blurp=kipas angin merk apa dengan led dan fan,description=kipas angin merk apa dengan led dan fan menggunakan usb power,price=250000,category=61af00ea8f64ae563008cdf2,in_stock=100,sold=0,shipping=Yes,color=Black,brand=Apple}
...
REACT_APP_SESSION_NAME=way-to-go-session
...
const sourcedir = 'node-mongodb/src'
...
--% /np/node-mongodb/src/core/crud-mongoose.js
  ...
  return {
    ...
    create: async ({body}, res, _) => {
      try {
        ...
        const object2 = new Model(body)
        const data2 = await object2.save();
        res.json(data2);
...
--% /np/node-mongodb/src/core/extender.js
// module.exports = () => ({
export default () => ({
...
--% /np/node-mongodb/src/core/crud.js
...
--% /np/node-mongodb/src/core/app.js
...
--% /np/node-mongodb/src/core/routes/index.js
const express = require('express');
...
--% /np/node-mongodb/src/core/routes/extension/index.js
...
--% /np/node-mongodb/src/core/routes/dummy/index.js
...
--% /np/node-mongodb/src/core/routes/api/users.js
...
--% /np/node-mongodb/src/core/routes/api/index.js
...
--% /np/node-mongodb/src/core/routes/api/auth.js
...
--% /np/node-mongodb/src/core/routes/generic/index.js
// import Cruder from 'C/crud';
import Cruder from 'C/crud-mongoose';
...
--% /np/node-mongodb/src/core/middlewares/cors.js
...
--% /np/node-mongodb/src/core/middlewares/index.js
...
--% /np/node-mongodb/src/core/middlewares/session.js
...
--% /np/node-mongodb/src/core/middlewares/body.js
...
--% /np/node-mongodb/src/core/middlewares/uploader.js
...
--% /np/node-mongodb/src/core/middlewares/morgan.js
...
--% /np/node-mongodb/src/core/middlewares/auth.js
import User from '../../apps/user/models';

const admin = require("../db/firebasedb");
...
--% /np/node-mongodb/src/core/db/mongo.js
...
--% /np/node-mongodb/src/core/db/postgres.js
...
--% /np/node-mongodb/src/core/db/index.js
...
--% /np/node-mongodb/src/core/db/firebasedb.js
...
--% /np/node-mongodb/src/core/db/firebasekey.json
{
...
--% /np/node-mongodb/src/apps/user/extender.js
...
--% /np/node-mongodb/src/apps/user/models/mongo.js
import mongoose from 'mongoose';
...
--% /np/node-mongodb/src/apps/user/models/postgres.js
import { default as dbConnect } from 'D';
import { 
  BIGINT, 
  BOOLEAN, 
...
--% /np/node-mongodb/src/apps/user/models/index.js
...
--% /np/node-mongodb/src/apps/user/auth/index.js
...
--% /np/node-mongodb/src/apps/user/auth/token.js
import { default as dbConnect } from 'D';
...
--% /np/node-mongodb/src/apps/user/auth/token_mongo.js
import mongoose from 'mongoose';
...
--% /np/node-mongodb/src/apps/user/auth/provider.js
...
--% /np/node-mongodb/src/apps/user/auth/kripto.js
...
--% /np/node-mongodb/src/apps/user/auth/jwt.js
...
--% /np/node-mongodb/src/server/server-dev.js
import express from 'express';
...
--% /np/node-mongodb/src/server/server-prod.js
...
--% /np/node-mongodb/__mocks__/styleMock.js
module.exports = {};


--#

--% /np/node-mongodb/__mocks__/fileMock.js
...
const sessionName = process.env.REACT_APP_SESSION_NAME || 'default-session-name';
...
--% /np/react-antd/utils/echartsHelper.js
--#

--% /np/react-antd/utils/patterns.js
--#

--% /np/react-antd/components/Route/Percobaan.js
--#
