...
class ClockBottom(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setStyleSheet(clock_bottom_stylesheet)
        ######################## START setupUi
        ...
        self.labelContent = ClockWidget(self)
        self.layout_main.addWidget(self.labelContent)

        self.layout_main.setStretch(1, 1)
        _translate = QCoreApplication.translate
        self.setWindowTitle(_translate("ClockBottom", "notification"))
        self.buttonClose.setText(_translate("ClockBottom", "r"))
...
#     # window = QWidget()
#     # window.hide()
#     # ClockBottom(parent=window, title='kuda').animate()
#     ClockBottom().animate()
#     sys.exit(app.exec_())
