class DevToInternal(QWidget):
    ...
    def setContent(self):
        ...
        for i, row in enumerate(self.data):
            # judul
            # column_labels = ['Title', 'Info', 'Author/Date/Reading', 'URL', 'Comment URL']
            judul = f"{row['title']}"
    ...
    def load_so(self):
        ...
        self.data = get_data_devto(code=f'{tag} {page}')
        # https://DevTo.com/questions/15848086/how-to-delete-all-rows-from-qtablewidget
    ...
    def onClicked(self, it):
        ...
        if it.column()in[3,4]: # url+comment url
            alamat = it.text()
