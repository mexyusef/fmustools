class LogRocketInternal(QWidget):
    ...
    def load_so(self):
        ...
        self.data = get_data_logrocket(code=f'{tag} {page}')
        # https://LogRocket.com/questions/15848086/how-to-delete-all-rows-from-qtablewidget
