...
def process_output(output):
        ...
        if k=='form':
            ...
            for l,w in output['form'].items():
                if w['type'] == 'input':
                    ...
                    label,check=w['children'][0].replace('_',' '), int(w['children'][1])
    ...
    content = gocode.replace('__TEMPLATE_CODE__', '\n\n'.join(template_codes))
    ...
    file_write('tviewform.go', content)
