...
.,d
  extras,d(/mk)
    cart,d(/mk,/load=ULIBPY_BASEDIR/app/quick/dahsyat/assistance/extras/cart.mk=index/fmus)
    order,d(/mk,/load=ULIBPY_BASEDIR/app/quick/dahsyat/assistance/extras/order.mk=index/fmus)
    product,d(/mk,/load=ULIBPY_BASEDIR/app/quick/dahsyat/assistance/extras/product.mk=index/fmus)
    user,d(/mk,/load=ULIBPY_BASEDIR/app/quick/dahsyat/assistance/extras/user.mk=index/fmus)
  store,d(/mk)
    user,d(/mk)
      userActions.js,f(t=)
