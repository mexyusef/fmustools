...
# lihat versi go:
# c:/src/go-qt/qt/internal/examples/widgets/treeview/treeview_dual/

"""
https://stackoverflow.com/questions/42718990/pyqt5-right-click-treewidget-item
this is how you add a right click contextual menu in a QtreeWidget Area
...
class MyMainWindow(QMainWindow):
    ...
    def config_widgets(self):
        ...
        self.folder_view.customContextMenuRequested.connect(self.folder_view_context_menu)
    ...
    def folder_view_context_menu(self, point):
        ...
        #     return
        # item = self.folder_view.itemAt(point)
        # index = indexes[0]
