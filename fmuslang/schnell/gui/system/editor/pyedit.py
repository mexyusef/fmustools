# https://gist.githubusercontent.com/Axel-Erfurt/8c84b5e70a1faf894879cd2ab99118c2/raw/1d4e9f6531e903b846683398964f267c84df9fb6/PyEdit2.py
# https://gist.github.com/Axel-Erfurt/8c84b5e70a1faf894879cd2ab99118c2
# https://www.dropbox.com/s/fs5u2d78nfb65wm/PyEdit.tgz?dl=1
# https://github.com/Axel-Erfurt/PyEdit2/blob/master/resources/wordlist.txt

# https://gist.github.com/Axel-Erfurt/d9f17a5aca61c8c14c4f7ea4dddc78cd
# https://gist.github.com/Axel-Erfurt/d2af483c3001876199a144f2d99076d6
  ...
  def runPy3(self):
      ...
      if not self.editor.toPlainText() == self.mainText:
          if self.filename:
              ...
              self.filename = f"{tempfile.gettempdir()}/tmp.py"
              self.fileSave()
              self.runPy3()
      else:
