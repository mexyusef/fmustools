...
def get_hicon(hWin):
	...
	File "C:/Users/usef/work/sidoarjo/schnell/gui/system/inputter/make_go.py", line 124, in data
		return self.items[index.row()].icon
	File "C:/Users/usef/work/sidoarjo/schnell/gui/system/inputter/make_go.py", line 93, in icon
		self._icon = winutils.get_window_icon(self.hwnd)
	File "C:/Users/usef/work/sidoarjo/schnell/gui/system/inputter/windows.py", line 322, in get_window_icon
		hicon = get_hicon(hwnd)
	File "C:/Users/usef/work/sidoarjo/schnell/gui/system/inputter/windows.py", line 291, in get_hicon
		hIcon = win32gui.LoadIcon(win32con.NULL, MAKEINTRESOURCE(win32con.IDI_APPLICATION))
	TypeError: Resource id/name must be unicode or int in the range 0-65536

	sblm exception, MAKEINTRESOURCE(win32con.IDI_APPLICATION): c_wchar_p(32512)
	"""
	...
	if hIcon == win32con.NULL:
		# resource_int = MAKEINTRESOURCE(win32con.IDI_APPLICATION)
		# print('sblm exception, MAKEINTRESOURCE(win32con.IDI_APPLICATION):', resource_int)
		# https://www.programcreek.com/python/example/89835/win32gui.LoadIcon
...
class tagWINDOWINFO(Structure):
	...
	def __str__(self):
		return '/n'.join([key + ':' + str(getattr(self, key)) for key, value in self._fields_])
