...
from app.dirutils import files_filter, sdirs, bongkar
from app.fileutils import file_write, get_daftar, file_content, get_definition_by_key_permissive_start
...
class GroupWidget(QWidget):
    ...
    def __init__(self, helpdir, toolbar_button=False, level=0):
        ...
        self.daftar_file = files_filter(helpdir, extension='.mk')
        self.folders = []
