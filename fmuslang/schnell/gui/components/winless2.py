...
class FramelessWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.setStyleSheet(contextmenu_stylesheet)
...
def main():
    ...
    app.setStyleSheet(frameless_stylesheet)
    ...
    w = FramelessWindow()
    w.setWindowTitle(f'Winless or Linful')
    # w.setWindowIcon(QIcon('Data/Qt.ico'))
    w.setWidget(MainWindow(w)) # 把自己的窗口添加进来
    resize_screen_ratio(w, screenw, screenh, 1/2, 1/2)
    # w.show()
    w.hide()
