...
from PyQt5.QtWidgets import QTableWidget, QTableWidgetItem, QLabel, QComboBox, QDateEdit, QDateTimeEdit, QSpinBox, QCheckBox, QSizePolicy, QGraphicsProxyWidget, QGraphicsLineItem, QMainWindow, QGraphicsView, QGraphicsPixmapItem, QGraphicsScene, QMenu, QStackedWidget
