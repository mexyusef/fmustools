# https://gist.githubusercontent.com/Axel-Erfurt/af8bc3ff7dc11809b5ed3710af915b13/raw/8e6e41595c1503f5591c03b8dcf6a3512ed8d8f1/PyQt5VideoPlayer
# https://gist.github.com/Axel-Erfurt/af8bc3ff7dc11809b5ed3710af915b13
...
class VideoPlayer(QWidget):
    ...
    def getYTUrl(self):
        youclip = self.clip.text()
        cmd = "youtube-dl -g -f best " + youclip
        print("grabbing YouTube URL {cmd}.")
    ...
    def wheelEvent(self,event):
        ...
        if self.widescreen == True:
            self.setGeometry(mleft, mtop, int(mwidth + mscale), int(round((mwidth + mscale) / 1.778))) 
        else:
            self.setGeometry(mleft, mtop, int(mwidth + mscale), int(round((mwidth + mscale) / 1.33)))
