...
class PushButtonLine(QPushButton):
    ...
    def __init__(self, *args, **kwargs):
        self._waitText = kwargs.pop("waitText", "Waiting")
    ...
    def paintEvent(self, event):
        ...
        pen.setWidth(4)
        painter.setPen(pen)
        painter.drawLine(0, self.height(), int(self.width() * self._percent), self.height())
...
class Window(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(PushButtonLine("Click to load"))
        layout.addWidget(PushButtonLine("Click to load").setLineColor("#ef5350"))
        layout.addWidget(PushButtonLine("Click to load").setLineColor("#ffc107"))
